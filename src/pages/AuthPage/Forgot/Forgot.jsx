...
import { Form, Input, Button, Checkbox, message, Row, Col, notification } from 'antd';
    ...
    const handleSendCode = async () => {
        try {
            ...
            api.success({
                ...
                description: 'Mã xác nhận đã được gửi đến email của bạn. Vui lòng kiểm tra hộp thư.',
                placement: 'topRight',
                duration: 4.5,
            });
            ...
            // Also use api for error message
            api.error({
                message: 'Lỗi gửi mã!',
