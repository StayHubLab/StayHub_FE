            ...
            <div className="hero-content">
                <div className="hero-text">
                    ...
                    <p className="hero-subtitle">
                        Loại bỏ rủi ro khi tìm trọ, tối ưu quy trình thuê, minh bạch trong quản lý và 
                        đánh giá – StayHub là nền tảng đồng hành đáng tin cậy trong hành trình trọ thời số hóa.
                    </p>
                </div>
