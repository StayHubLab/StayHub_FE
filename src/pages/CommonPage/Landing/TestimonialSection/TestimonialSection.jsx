  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment: "StayHub giúp mình tìm được phòng trọ gần trường với giá hợp lý chỉ trong 2 ngày. Quy trình đăng ký đơn giản và chủ trọ rất uy tín.",
    ...
    },
    {
      ...
      rating: 5,
      comment: "Từ khi sử dụng StayHub, tỷ lệ lấp phòng của mình tăng 80%. Hệ thống quản lý rất chuyên nghiệp và tiện lợi.",
    ...
    },
    {
      ...
      rating: 5,
      comment: "Dịch vụ tuyệt vời! Đội ngũ hỗ trợ nhiệt tình, phản hồi nhanh. Mình đã giới thiệu StayHub cho nhiều bạn bè.",
      ...
      <div className="testimonial-container">
        <div className="testimonial-header">
          ...
          <Text className="testimonial-subtitle">
            Hàng ngàn người dùng đã tìm được nơi ở lý tưởng và quản lý tài sản hiệu quả với StayHub          </Text>
        </div>
        ...
        <div className="testimonial-stats">
          <Row gutter={[48, 24]} justify="center">
            <Col xs={12} sm={6} className="stat-item">
              <Title level={2} className="stat-number">100K+</Title>
              <Text className="stat-label">Người dùng</Text>
            </Col>
            <Col xs={12} sm={6} className="stat-item">
              <Title level={2} className="stat-number">50K+</Title>
              <Text className="stat-label">Phòng trọ</Text>
            </Col>
            <Col xs={12} sm={6} className="stat-item">
              <Title level={2} className="stat-number">15K+</Title>
              <Text className="stat-label">Chủ trọ</Text>
            </Col>
            <Col xs={12} sm={6} className="stat-item">
              <Title level={2} className="stat-number">4.9/5</Title>
