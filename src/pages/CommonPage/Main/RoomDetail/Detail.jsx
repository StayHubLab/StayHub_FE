...
const Detail = () => {
        ...
        reviews: [
            {
                ...
                date: "Tháng 5, 2023",
                rating: 5,
                comment: "Phòng rất sạch sẽ và đầy đủ tiện nghi. Chủ nhà thân thiện và luôn hỗ trợ khi cần. Vị trí thuận tiện, gần chợ và siêu thị. Tôi rất hài lòng với thời gian ở đây.",
            ...
            },
            {
                ...
                date: "Tháng 4, 2023",
                rating: 5,
                comment: "Phòng rộng rãi, thoáng mát. Điều hòa và wifi hoạt động tốt. Khu vực an ninh, yên tĩnh. Chỉ có điều nước nóng thỉnh thoảng không ổn định.",
                avatar: "https://placehold.co/40x40"
            }
        ]
    });
    ...
    return (
        <div className="detail-container">
            ...
            <div style={{ marginBottom: '100px' }}>   {/* tăng marginBottom */}
                <RoomImages
                    images={images}
                    isVerified={true}
