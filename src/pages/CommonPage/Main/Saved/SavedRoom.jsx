            ...
            <div className="saved-room-container">
                ...
                {savedRooms.length > 0 ? (
                    <>
                        <div className="saved-room-cards-grid">
                            {savedRooms.map((room, index) => (
                                <div key={room.id} className={`saved-room-card saved-room-card-${index + 1}`}>
                                    {/* Room Image */}
                                    <div className="saved-room-image-container">
                                        ...
                                        {room.isVerified && (
                                            <div className="saved-room-verified-badge">
                                                ...
                                                <div className="saved-room-verified-badge-text">Đã xác thực</div>
                                            </div>
                                        )}
                                    </div>
                                    ...
                                    <div className="saved-room-card-content">
                                        {room.isAIRecommended && (
                                            <div className="saved-room-ai-badge">
                                                <div className="saved-room-ai-badge-text">AI đề xuất</div>
                                            </div>
                                        )}
                                        ...
                                        <div className="saved-room-card-location">{room.location}</div>
                                        ...
                                        <div className="saved-room-rating-section">
                                            ...
                                            <div className="saved-room-review-count">({room.reviews} đánh giá)</div>
                                        </div>

                                        <div className="saved-room-view-details">
                                            <div className="saved-room-view-details-text">Xem chi tiết</div>
                                        </div>
                                    </div>
                                </div>
                            ))}
                    ...
                    <div className="saved-room-empty-state">
                        ...
                        <div className="saved-room-empty-title">Chưa có phòng nào được lưu</div>
