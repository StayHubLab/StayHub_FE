...
const RoomTable = ({ rooms, loading, onView, onEdit, onDelete }) => {
  ...
  const getStatusTag = (status) => {
    ...
    return <Tag color={config.color} className="landlord-status-tag">{config.label}</Tag>;
  };
  ...
  const columns = [
    {
      ...
      render: (text) => <Text strong className="landlord-room-code">{text}</Text>
    },
    {
      title: 'Tên phòng',
      dataIndex: 'name',
