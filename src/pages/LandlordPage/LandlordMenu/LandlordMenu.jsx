    ...
    <div className="landlord-menu-container">
      <div className="landlord-menu-content">
        {menuItems.map((item, index) => (
          ...
          >
            <div className={`landlord-menu-item-background ${activeItem === item.id ? 'active-bg' : ''}`}>
              <div className="landlord-menu-icon-container">
                <div className="landlord-menu-icon">
                  {item.icon}
                </div>
              </div>
              <div className="landlord-menu-text-container">
                <div className={`landlord-menu-text ${activeItem === item.id ? 'active-text' : ''}`}>
                  {item.label}
                </div>
              </div>
            </div>
