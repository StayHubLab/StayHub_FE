          ...
          <Card title="Thông tin cá nhân" className="settings-card">
            ...
            >
              ...
              <Form.Item name="password" label="Mật khẩu mới">
                <Input.Password prefix={<LockOutlined />} placeholder="Để trống nếu không đổi" />
              </Form.Item>
          ...
          <Card title="Cài đặt thông báo" className="settings-card">
            <div className="notification-item">
              <div>
                ...
                <div className="notification-desc">Nhận thông báo qua email</div>
              </div>
            ...
            <div className="notification-item">
              <div>
                ...
                <div className="notification-desc">Thông báo khi có giao dịch mới</div>
              </div>
              <Switch defaultChecked />
            </div>
            ...
            <div className="notification-item">
              <div>
                ...
                <div className="notification-desc">Nhận thông báo lịch xem phòng</div>
              </div>
              <Switch defaultChecked />
            </div>
            ...
            <div className="notification-item">
              <div>
                ...
                <div className="notification-desc">Gửi báo cáo doanh thu hàng tháng</div>
              </div>
              <Switch />
            </div>
          </Card>
